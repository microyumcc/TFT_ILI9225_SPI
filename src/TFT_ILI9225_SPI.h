...
class TFT_ILI9225_SPI {
    ...
    public:
        ...
        TFT_ILI9225_SPI(int8_t RST, int8_t RS, int8_t CS, int8_t SDI, int8_t CLK, int8_t LED);
        TFT_ILI9225_SPI(int8_t RST, int8_t RS, int8_t CS, int8_t LED);
        TFT_ILI9225_SPI(int8_t RST, int8_t RS, int8_t CS, int8_t SDI, int8_t CLK, int8_t LED, uint16_t brightness);
        TFT_ILI9225_SPI(int8_t RST, int8_t RS, int8_t CS, int8_t LED, uint16_t brightness);
